...
export default {
  ...
  methods: {
    getYoutubeLink() {
      if (this.blog.youtube_link) {
        return this.blog.youtube_link;
      }
      return "";
    },//end of getYoutubeLink
    ...
    submitBlog() {
      ...
      this.loading = true;
      axios
        .post(`/api/admin/blogs/${this.$route.params.id}`, this.generateFormData())
        .then((response) => {
